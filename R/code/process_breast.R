#加载文件
#file_path = "/Users/liguangping/Desktop/R/data/GSE27567_RAW";
...
#归一化并分组
eset = mas5(raw_data)
ill = get.array.subset(eset, 'state', 'malignant_breast_cancer')
normal = get.array.subset(eset, 'state', 'healthy')

#保存

##保存ill
ncol(ill)
file_name = paste(out_path, 'breast_ill_17mas5.csv',sep = "")
mat = exprs(ill)
write.csv(mat, file_name)

##保存normal
ncol(normal) 
file_name = paste(out_path, 'breast_normal_20mas5.csv',sep = "")
mat = exprs(normal)
write.csv(mat, file_name)
